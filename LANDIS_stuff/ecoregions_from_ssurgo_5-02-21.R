...
#no longer need to do this either since names are fixed :) 
...
write.csv(Dcomb, file="~/mastersthesis_repo/mastersthesis/LANDIS_stuff/Dcomb_2May2021.csv",row.names=FALSE)
